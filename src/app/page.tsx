...
import { ImageIcon, FileTextIcon, GlobeIcon, LightbulbIcon, MessageSquare, Globe, Users, Target, Wrench, ArrowRight, Sparkles } from 'lucide-react'; // Imported specific Lucide icons
        ...
        <header className="py-16 bg-gradient-to-r from-[#111] to-[#0a0a0a]">
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-4">
              <Link href="/agent-studio" className="gap-2 bg-amber-500 hover:bg-amber-600 text-black font-bold">
                <Button size="lg" className="gap-2 bg-amber-500 hover:bg-amber-600 text-black font-bold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="bg-[#111] border-blue-800 hover:border-blue-600 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription>
                    Analyze any website to extract business intelligence
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-400 mb-4">
                    Extract key information about competitors, industry trends, and marketing strategies.
                  </p>
                </CardContent>
                <CardFooter>
              ...
              <Card className="bg-[#111] border-purple-800 hover:border-purple-600 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription>
                    Create detailed executive profiles for targeted outreach
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-400 mb-4">
                    Generate communication profiles for executives to craft personalized messages.
                  </p>
                </CardContent>
                <CardFooter>
              ...
              <Card className="bg-[#111] border-green-800 hover:border-green-600 transition-colors">
                <CardHeader>
                  ...
                  <CardTitle>Deal Writer</CardTitle>
                  <CardDescription>
                    Generate tailored proposals for specific prospects
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-400 mb-4">
                    Create customized deal proposals that address specific pain points and opportunities.
                  </p>
                </CardContent>
                <CardFooter>
              ...
              <Card className="bg-[#111] border-amber-800 hover:border-amber-600 transition-colors">
                <CardHeader>
                  <Sparkles className="h-8 w-8 text-amber-500 mb-2" />
                  <CardTitle>AI Agent Studio</CardTitle>
                  <CardDescription>
                    Create and deploy specialized AI agents
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-400 mb-4">
                    Build custom AI agents to automate tasks and integrate with your Kanban workflows.
                  </p>
                </CardContent>
                <CardFooter>
                  <Link href="/agent-studio" className="w-full">
                    <Button variant="outline" className="w-full border-amber-800 hover:bg-amber-900/20">
